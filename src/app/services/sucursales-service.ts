...
export class SucursalesService {
  ...
  //---------------------------------------------//
  public static URLSERVICIO: string = Configuraciones.sucursalesUrl;
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        this.http.get(url,  httpOptions).subscribe((data : any)   => {
         ...
         let respuesta = data.datos.sucursales
  ...
  */
  private getURLServicio() {
    ...
    return SucursalesService.URLSERVICIO + `${this.usuarioActual.cuenta.id}`;
  }
